...
class PPO:
    ...
    def learn(self, total_timesteps):
        ...
        while t_so_far < total_timesteps:                                                                       # ALG STEP 2
            ...
            if i_so_far % self.save_freq == 0:
                torch.save(self.actor.state_dict(), './ppo_actor_def.pth')
                torch.save(self.critic.state_dict(), './ppo_critic_def.pth')
    ...
    def act(self, obs, reward, done):
        ...
        if self._next_attack_time is None:
            self._next_attack_time = 1 + np.random.randint(self._attack_period)
    ...
    def convert_obs(self, o):
        ...
        return torch.tensor([np.concatenate(li_vect)])
        '''
